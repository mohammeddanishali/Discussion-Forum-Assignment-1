...
public class Question extends AbstractEntity {
	...
	public void autoGenerateId() {
		...
		// 1. Call the parent class' setId method and pass in lastEntry as the method
		// variable;
	 ...
	 *
	 * @param message: the message that we want to set the details of this question
	 *                 to
	 */
	public void setMessage(String message) {
		// please write your code here
		// you should set the instance variable message to the parameter variable
		// message
